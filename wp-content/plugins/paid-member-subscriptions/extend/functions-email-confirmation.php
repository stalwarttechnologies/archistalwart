...
function pms_pb_email_confirmation_payment_form( $message ) {
    ...
    $signup_data = wppb_get_signup_data( $_GET['activation_key'] );
    ...
    $member = pms_get_member( username_exists( $signup_data->user_login ) );
...
function pms_pb_remove_email_confirmation_redirect( $redirect_url ) {
    ...
    $signup = wppb_get_signup_data( $_GET['activation_key'] );
...
function pms_pb_email_confirmation_handle_form_submission() {
    ...
    $user_id = wppb_get_user_id_by_activation_key( $_GET['activation_key'] );
